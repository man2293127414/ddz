...
import com.ddz.server.shuffle.Passion2ShuffleStrategy;
import com.ddz.server.shuffle.PassionShuffleStrategy;
import com.ddz.server.shuffle.RandomShuffleStrategy;
import com.ddz.server.shuffle.ShuffleStrategy;
...
public class GameRoom {
    ...
    //记录上一局的赢家ID ---
    private String lastWinnerId = null;
    ...
    private void startGame() {
        ...
        if(this.lastWinnerId==null){
            ...
            // 情况2：后续牌局，由上局赢家先叫
            currentPlayerIndex = playerIds.indexOf(this.lastWinnerId);

            // 防御性编程：如果上局赢家断线了，indexOf 会返回 -1，此时需要回退到随机模式
    ...
    private void shuffle() {
        ...
        switch (randomShuffle){
            case 1:
                this.shuffleStrategy = new PassionShuffleStrategy();
                break;
            case 2:
                this.shuffleStrategy = new Passion2ShuffleStrategy();
                break;
            default:
                this.shuffleStrategy = new RandomShuffleStrategy();
                break;
        }
        deck = shuffleStrategy.shuffle(lastWinnerId, players, landlordCards);
    }
